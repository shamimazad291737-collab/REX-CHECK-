...
def get_admin_panel_data():
    ...
    markup = {
        "inline_keyboard": [
            ...
            [{"text": "🔍 Set Rex Checker Link", "callback_data": "admin_set_rex_link"}],
    ...
    try:
        ...
        if "message" in update:
            ...
            if text == "/start":
                ...
                markup = {
                    "inline_keyboard": [
                        [{"text": f"👤 Buy Single Number (${format_number_price(current_price)})", "callback_data": "confirm_buy_usa"}],
                ...
                markup = {
                    "inline_keyboard": [
                        [{"text": f"🛡️ NordVPN (${nord_pr:.2f})", "callback_data": "buy_vpn_nord"}],
                        [{"text": f"🛡️ ProtonVPN (${proton_pr:.2f})", "callback_data": "buy_vpn_proton"}]
                    ]
                }
