            ...
            if state_data:
                ...
                if isinstance(state_data, dict) and state_data.get("step") == "WAITING_AMOUNT":
                    ...
                    try:
                        ...
                        target_info = get_user(target_user)
                        target_name = target_info[1] if target_info else "NoUsername"
                        current_balance = target_info[2] if target_info else Decimal("0")

                        if usd_val > current_balance:
                            send_message(chat_id, f"❌ <b>ব্যালেন্স মাইনাস করা যায়নি।</b> User @{target_name}-এর বর্তমান ব্যালেন্স ${format_money_exact(current_balance)} USD।")
                            delete_user_state(user_id)
                            return
